...
PE= pe 350 125  /N/project/solsex/_sapp/reads/illumina/illum_all_R1.fastq.gz  /N/project/solsex/_sapp/reads/illumina/illum_all_R2.fastq.gz # all illumina reads from both male and female
#Illumina mate pair reads supplied as <two-character prefix> <fragment mean> <fragment stdev> <forward_reads> <reverse_reads>
#JUMP= sh 3600 200  /FULL_PATH/short_1.fastq  /FULL_PATH/short_2.fastq
#pacbio OR nanopore reads must be in a single fasta or fastq file with absolute path, can be gzipped
#if you have both types of reads supply them both as NANOPORE type
PACBIO=/N/project/solsex/_sapp/reads/pac/pac_all.fasta   # all PACBIO reads from both male and female
